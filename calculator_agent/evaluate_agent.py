...
def plot_coordinate_error(df):

    error = (

        (

            (df["predicted_x"] - df["actual_x"]) ** 2

            +

            (df["predicted_y"] - df["actual_y"]) ** 2
